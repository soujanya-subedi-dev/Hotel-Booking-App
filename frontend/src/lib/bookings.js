...
export const getBooking     = ()         => Promise.reject(new Error('getBooking not supported in backend v1'));
export const updateBooking  = ()  => Promise.reject(new Error('updateBooking not supported in backend v1'));
